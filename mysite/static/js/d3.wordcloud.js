...
(function() {
  function wordcloud() {
	function getColor(str) {
	  var color_palettes = ['#4abdac', '#fc4a1a', '#f7b733', '#f03b20', '#feb24c', '#ffeda0', '#007849', '#0375b4', '#ffce00', '#373737', '#07889b', '#eeaa7b', '#062f4f', '#813772', '#b82601', '#565656', '#76323f', '#c09f80'];
	  return color_palettes[str.length % color_palettes.length];
	}
    ...
    var selector = '#wordcloud',
		...
		// fill = d3.scale.linear().range(color_palettes),
